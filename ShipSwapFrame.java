   ...
   //what happens is a slot is selected for ship 1
      ...
      add(infoSide,BorderLayout.WEST);*/
         ...
         // 			
            ...
            picSide.add(picture, BorderLayout.PAGE_START);
         	*/
				picSide = new PicSidePanel(ship.getImageFile());
				picSide.setPreferredSize(new Dimension(length / 2, height));
...
class PicSidePanel extends JPanel{
	...
	Image bgImage;
	public PicSidePanel(String imageFile){
		bgImage = Toolkit.getDefaultToolkit().createImage(imageFile);
